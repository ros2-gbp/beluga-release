...
Name:           ros-kilted-beluga-amcl
Version:        2.1.1
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS beluga_amcl package

License:        Apache License 2.0
URL:            https://index.ros.org/p/beluga_amcl/#kilted
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-kilted-beluga
Requires:       ros-kilted-beluga-ros
...
BuildRequires:  ros-kilted-beluga
BuildRequires:  ros-kilted-beluga-ros
