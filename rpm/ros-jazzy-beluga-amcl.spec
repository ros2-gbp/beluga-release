...
Name:           ros-jazzy-beluga-amcl
Version:        2.1.1
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS beluga_amcl package

License:        Apache License 2.0
URL:            https://index.ros.org/p/beluga_amcl/#jazzy
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-jazzy-beluga
Requires:       ros-jazzy-beluga-ros
...
BuildRequires:  ros-jazzy-beluga
BuildRequires:  ros-jazzy-beluga-ros
